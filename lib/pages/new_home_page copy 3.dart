...
class _NewHomePageCopy3State extends State<NewHomePageCopy3>
  ...
  void initState() {
    getPopularMovies()
        .then((value) => print('initState then popularMovies got!'))
        .whenComplete(() => print('initState whenComplete popularMovies got!'));
    print('isDataRecieved : $isDataRecieved');
    super.initState();
  }
            ...
            children: [
              ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  // items[index - 1].image,
                  fit: BoxFit.cover,
                  filterQuality: FilterQuality.medium, //was high
                  height: 150,
                  width: 109,
                ),
              ),
