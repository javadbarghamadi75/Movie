...
class NewHomePageCopy2 extends StatefulWidget {
  final String title;

  const NewHomePageCopy2({Key? key, required this.title}) : super(key: key);

  @override
  _NewHomePageCopy2State createState() => _NewHomePageCopy2State();
}
...
class _NewHomePageCopy2State extends State<NewHomePageCopy2>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      extendBody: true,
      appBar: AppBar(
        backgroundColor: Colors.white, //amber
      ...
      backgroundColor: Colors.grey[50], //grey[50]
      body: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          return searchedItems.length != 0 || _controller.text.isNotEmpty
              ? _sortListView(index)
