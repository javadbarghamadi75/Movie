...
class NewHomePageCopy4 extends StatefulWidget {
  final String title;

  const NewHomePageCopy4({Key? key, required this.title}) : super(key: key);

  @override
  _NewHomePageCopy4State createState() => _NewHomePageCopy4State();
}

class _NewHomePageCopy4State extends State<NewHomePageCopy4>
...
class PersistentHeader extends SliverPersistentHeaderDelegate {
  ...
  @override
  double get maxExtent => AppBar().preferredSize.height + 5;
